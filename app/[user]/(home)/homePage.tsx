        ...
        return (
          <View className="flex-1 bg-secondary items-center justify-center gap-y-10 px-5">
            ...
            <View className="flex-col items-center justify-center gap-y-2">
              <Text className="text-grey text-4xl text-center font-f500">
                Tap your profile picture to add your friend!
              </Text>
            </View>
          </View>
        )
      case "pending":
        return (
          <View className="flex-1 bg-secondary items-center justify-center gap-y-10 px-5">
            ...
            <View className="flex-col items-center justify-center gap-y-2">
              <Text className="text-grey text-4xl text-center font-f500">
                Waiting for {pendingFriendName} to accept your request!
              </Text>
            </View>
          </View>
        )
